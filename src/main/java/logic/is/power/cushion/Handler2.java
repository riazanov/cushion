...
package logic.is.power.cushion;
  ...
  /**
   * Common interface for various handlers of pairs of data items.
   * See also {@link cushion_je.SimpleReceiver}.
   */
public interface Handler2<T1,T2> {

    /** Handles the data item pair <code>(val1,val2)</code>; the specific 
     *  semantics is up to the implementations.
     */
    public void handle(T1 val1,T2 val2);
